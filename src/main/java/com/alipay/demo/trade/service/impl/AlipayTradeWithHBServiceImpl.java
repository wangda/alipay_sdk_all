...
import com.alipay.demo.trade.service.AlipayClientFactory;
...
public class AlipayTradeWithHBServiceImpl extends AbsAlipayTradeService {
    ...
    public static class ClientBuilder {
        private F2FPayAccount payAccount;
        ...
        public ClientBuilder setPayAccount(F2FPayAccount payAccount) {
        ...
        public F2FPayAccount getPayAccount() {
            return payAccount;
        }
    }
    ...
    public AlipayTradeWithHBServiceImpl(ClientBuilder builder) {
        ...
        if (builder.getPayAccount() == null) {
            ...
            client = AlipayClientFactory.getAlipayClient(builder.getPayAccount());
        }
    }
